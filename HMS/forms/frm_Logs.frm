...
Begin VB.Form frm_Logs 
   BackColor       =   &H00D8E9EC&
   Caption         =   "User's Log Report"
   ClientHeight    =   6435
   ClientLeft      =   60
   ClientTop       =   375
   ClientWidth     =   7560
   ControlBox      =   0   'False
   Icon            =   "frm_Logs.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   429
   ScaleMode       =   3  'Pixel
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Logs.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Logs.frx":0B24
               Key             =   ""
            EndProperty
         EndProperty
      End
...
On Error GoTo err:
    ...
    If rs.State = adStateOpen Then rs.Close
        ...
        sql = "SELECT * from tblUserLog ORDER BY tblUserLog.ID DESC"
        rs.Open sql, cn, adOpenKeyset, adLockPessimistic
        
    Do While rs.EOF = False
        Me.listRecord.ListItems.Add , , rs.Fields("Fullname").Value
        Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(1) = rs.Fields("username").Value
        Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(2) = "**************"
        Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(3) = rs.Fields("oDate").Value
        Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(4) = rs.Fields("oTime").Value
        rs.MoveNext
    Loop
