...
Begin VB.Form frm_checkin 
   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin VB.ComboBox cbo_nationality 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_checkin.frx":0000
         Left            =   1920
         List            =   "frm_checkin.frx":001C
         Locked          =   -1  'True
         TabIndex        =   8
         Text            =   "Filipino"
         Top             =   4560
...
Private Sub reposition()
    ...
    Me.Left = (Screen.Width / 2) - (Me.Width / 2) - (5210 / 2)
End Sub
...
Private Sub txtGRno_GotFocus()
    HLTxt txtGRno
End Sub

Private Sub txtGRno_KeyPress(KeyAscii As Integer)
 Select Case KeyAscii
        Case 46
            KeyAscii = 0
        Case vbKeyBack
...
On Error GoTo err:
    ...
    If txtGRno.Text = "N/A" Or txtGRno.Text = "" Then
        MsgBox "Please enter GR Number. Thank You", vbInformation
        Me.txtGRno.SetFocus
        Exit Sub
    End If
    ...
    End If
    With rs
        If isRInfo = False Then
            .AddNew
            .Fields("grNo").Value = Me.txtGRno.Text
        ...
        Else
            ...
            get_trans_id
            updateRooms
            frm_Welcome.DelReserved
        End If
        
    End With
   
    'MsgBox "Customer's Data successfully save. Thank you", vbInformation
    

    LockDataEntry
    chkTimeDays
    frm_Welcome.loadRooms
    frm_Payment.cmdClose.Enabled = True
    frm_Confirm.Show
    'frm_Payment.getNoDays
    'Unload Me
    Exit Sub
err:
...
Private Sub UnlockDataEntry()
    Me.txtGRno.Locked = False
    Me.txtGRno.BackColor = vbWhite
...
Private Sub LockDataEntry()
    Me.txtGRno.Locked = True
    Me.txtGRno.BackColor = &H8000000B
...
On Error GoTo err:
    If rs.State = adStateOpen Then rs.Close
    rs.Open "Select * from tblroom where Room_no = " & Me.lblroomno & ";", cn, adOpenKeyset, adLockPessimistic
    rs.Fields("occupied").Value = "true"
...
Private Sub chkTimeDays()
If Format(Time, "HHMMSS") >= 100 And Format(Time, "HHMMSS") <= 50000 Then
    frm_Payment.cboDays.Text = "1"
ElseIf Format(Time, "HHMMSS") >= 50100 And Format(Time, "HHMMSS") <= 120000 Then
    frm_Payment.cboDays.Text = "0.5"
Else
    frm_Payment.cboDays.Text = "1"
End If
    Load frm_Payment
