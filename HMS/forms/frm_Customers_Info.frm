...
Begin VB.Form frm_CInfo 
   BackColor       =   &H00D8E9EC&
   Caption         =   "Customer's Information Section"
   ClientHeight    =   6435
   ClientLeft      =   60
   ClientTop       =   375
   ClientWidth     =   7560
   ControlBox      =   0   'False
   Icon            =   "frm_Customers_Info.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   429
   ScaleMode       =   3  'Pixel
   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Customers_Info.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Customers_Info.frx":0B24
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin HMS.b8SContainer pbBGButton 
         ...
         Begin VB.ComboBox cboSearch 
            ...
            EndProperty
            Height          =   405
            ItemData        =   "frm_Customers_Info.frx":10BE
            Left            =   1440
            List            =   "frm_Customers_Info.frx":10C8
      ...
      Begin HMS.b8ChildTitleBar b8Title 
         ...
         _ExtentY        =   609
         BackColor       =   12735512
         Caption         =   "Customer's Information Manager"
      ...
      Begin MSComctlLib.ImageList ilRecordIco 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   1
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Customers_Info.frx":10E0
               Key             =   ""
            EndProperty
         EndProperty
      End
...
On Error GoTo err:
    ...
    If chkSType = 1 Then
        rs.Open " SELECT * From tblCustomerInfo where lastname like """ & Me.txtSearch.Text & "%"";", cn, adOpenKeyset, adLockPessimistic
        'rs.Open "Select * from  qryDailyReport where lastname like '" & Me.txtSearch.Text & "%';", cn, adOpenKeyset, adLockPessimistic
    Else
        rs.Open " SELECT * From tblCustomerInfo where Company like """ & Me.txtSearch.Text & "%"";", cn, adOpenKeyset, adLockPessimistic
    ...
    Do While rs.EOF = False
        If rs.Fields("Stat").Value <> "R" Then
            ...
            Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(4) = rs.Fields("Email").Value
            Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(5) = rs.Fields("Nationality").Value
            Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(6) = rs.Fields("HomeAdd").Value
            Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(7) = rs.Fields("Stat").Value
            Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(8) = rs.Fields("TransactionID").Value
        End If
        rs.MoveNext
    Loop
    Exit Sub
...
If Button = vbRightButton Then
    Call PopupMenu(mdiMain.mnupopEdit)
End If
End Sub
