...
Begin VB.Form frm_Unpaid 
   BackColor       =   &H00D8E9EC&
   Caption         =   "Unpaid Report Manager"
   ClientHeight    =   6435
   ClientLeft      =   60
   ClientTop       =   375
   ClientWidth     =   7560
   ControlBox      =   0   'False
   Icon            =   "frm_Unpaid.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   429
   ScaleMode       =   3  'Pixel
   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Unpaid.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Unpaid.frx":0B24
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin HMS.b8SContainer pbBGButton 
         ...
         Begin VB.ComboBox cboSearch 
            ...
            EndProperty
            Height          =   405
            ItemData        =   "frm_Unpaid.frx":10BE
            Left            =   1440
            List            =   "frm_Unpaid.frx":10C8
  ...
  If rs.State = adStateOpen Then rs.Close
    ...
    Do While rs.EOF = False
     'MsgBox Format(rs.Fields("occu_date").Value, "MMDDYY") & " <= " & Format(Me.dtPicker.Value, "MMDDYY")
        ...
        End If
        On Error Resume Next
        'MsgBox Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(12)
        If Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(12) <= 0 Then
            Me.listRecord.ListItems.Remove (Me.listRecord.ListItems.Count)
        End If
...
Private Sub expDRM()
    ...
    Next i
        ...
        xlApp.Quit
End Sub
Private Sub listRecord_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Me.listRecord.ListItems.Count <> 0 Then
        If Button = vbRightButton Then
            PopupMenu mdiMain.mnulPay
        End If
    End If
End Sub
