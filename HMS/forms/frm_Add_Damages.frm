...
Begin VB.Form frm_Add_Damages 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Damages Entry Section"
   ClientHeight    =   6435
   ClientLeft      =   45
   ClientTop       =   315
   ClientWidth     =   5355
   ...
   Begin VB.Image Image2 
      Height          =   525
      Left            =   0
      Picture         =   "frm_Add_Damages.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7185
   End
End
Attribute VB_Name = "frm_Add_Damages"
...
On Error GoTo eh
    ...
    cn.Execute "DELETE FROM tblDamages WHERE ID = " & Me.lvlList.SelectedItem.Text
    'Me.lvwUser.SetFocus
...
Private Sub cmdSave_Click()
    With rs
        If isEditM = False Then         'add record to database
            ...
            .Open "SELECT * FROM tblDamages WHERE ID = 0;", cn, adOpenKeyset, adLockOptimistic
            .AddNew
            .Fields("dDamages") = Me.txtMeals.Text
            .Fields("dPrice") = Me.txtPrice.Text
            .Update
            MsgBox "New record saved.", vbInformation
        ElseIf isEditM = True Then    'update current record
            If .State = adStateOpen Then .Close
            .Open "SELECT * FROM tblDamages WHERE ID = " & Me.lvlList.SelectedItem.Text, cn, adOpenKeyset, adLockOptimistic
            .Fields("dDamages") = Me.txtMeals.Text
            .Fields("dPrice") = Me.txtPrice.Text
            .Update
...
On Error GoTo err:
     ...
     Do While rs.EOF = False
        ...
        Me.lvlList.ListItems(Me.lvlList.ListItems.Count).SubItems(1) = rs.Fields("dDamages").Value
        Me.lvlList.ListItems(Me.lvlList.ListItems.Count).SubItems(2) = FormatNumber(rs.Fields("dPrice").Value, 2)
     rs.MoveNext
     Loop
    Exit Sub
err:
