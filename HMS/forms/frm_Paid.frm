...
Begin VB.Form frm_Paid 
   BackColor       =   &H00D8E9EC&
   Caption         =   "Paid Report Manager"
   ClientHeight    =   6435
   ClientLeft      =   60
   ClientTop       =   375
   ClientWidth     =   7560
   ControlBox      =   0   'False
   Icon            =   "frm_Paid.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   429
   ScaleMode       =   3  'Pixel
   ...
   Begin VB.PictureBox bgMain 
      ...
      Begin MSComctlLib.ImageList icoHeader 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Paid.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Paid.frx":0B24
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin HMS.b8SContainer pbBGButton 
         ...
         Begin VB.ComboBox cboSearch 
            ...
            EndProperty
            Height          =   405
            ItemData        =   "frm_Paid.frx":10BE
            Left            =   1440
            List            =   "frm_Paid.frx":10C8
     ...
     'MsgBox Format(rs.Fields("occu_date").Value, "MMDDYY") & " <= " & Format(Me.dtPicker.Value, "MMDDYY")
        If rs.Fields("Stat").Value <> "R" Then
                If Format(rs.Fields("occu_date").Value, "MMDDYY") <= Format(Me.dtPicker.Value, "MMDDYY") Then
                    ...
                    'Me.listRecord.ListItems(Me.listRecord.ListItems.Count).SubItems(19) = rs.Fields("isAdPer").Value
